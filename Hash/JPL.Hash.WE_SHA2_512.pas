...
uses
  ...
  Hash, Mem_util, sha512
  ;

const
  HASH_BUFFER_SIZE_SHA512 = 1024*63; // 1024 * 100; // F000 = 61 440 bytes


function WeGetFileHash_SHA2_512(fName: string; var HashResult: THashResultRec; HashEnumProc: THashEnumProc = nil): Boolean;
function WeGetStreamHash_SHA2_512(AStream: TStream; var HashResult: THashResultRec; StartPos: Int64 = 0; HashEnumProc: THashEnumProc = nil): Boolean;
...
var
  ...
  BufNo: integer;
  Buffer: array[0..HASH_BUFFER_SIZE_SHA512-1] of Byte;
...
begin
  ...
  try
    ...
    HashResult.HashType := htSha2_512;
    SHA512Init(Context);
    ...
    begin
      ...
      if xRead > 0 then SHA512Update(Context, @Buffer, xRead);
...
begin
  ...
  try
    Result := WeGetStreamHash_SHA2_512(fs, HashResult, 0, HashEnumProc);
  finally
    fs.Free;
  end;
end;

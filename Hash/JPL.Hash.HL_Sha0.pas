...
uses
  ...
  HlpHash, HlpHashResult, HlpIHashResult, HlpSHA0;
...
function HlGetFileHash_Sha0(fName: string; var HashResult: THashResultRec; HashEnumProc: THashEnumProc = nil): Boolean;
function HlGetStreamHash_Sha0(AStream: TStream; var HashResult: THashResultRec; StartPos: Int64 = 0; HashEnumProc: THashEnumProc = nil): Boolean;
...
begin
  ...
  try
    Result := HlGetStreamHash_Sha0(fs, HashResult, 0, HashEnumProc);
  finally
    fs.Free;
  end;
end;

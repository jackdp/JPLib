...
uses
  ...
  Hash, Mem_util, sha224
  ;

const
  HASH_BUFFER_SIZE_SHA224 = 1024*63; // 1024 * 100; // F000 = 61 440 bytes


function WeGetFileHash_SHA2_224(fName: string; var HashResult: THashResultRec; HashEnumProc: THashEnumProc = nil): Boolean;
function WeGetStreamHash_SHA2_224(AStream: TStream; var HashResult: THashResultRec; StartPos: Int64 = 0; HashEnumProc: THashEnumProc = nil): Boolean;
...
var
  ...
  BufNo: integer;
  Buffer: array[0..HASH_BUFFER_SIZE_SHA224-1] of Byte;
...
begin
  ...
  try
    ...
    HashResult.HashType := htSha2_224;
    SHA224Init(Context);
    ...
    begin
      ...
      if xRead > 0 then SHA224Update(Context, @Buffer, xRead);
...
begin
  ...
  try
    Result := WeGetStreamHash_SHA2_224(fs, HashResult, 0, HashEnumProc);
  finally
    fs.Free;
  end;
end;

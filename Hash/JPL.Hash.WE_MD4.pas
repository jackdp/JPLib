...
const
  HASH_BUFFER_SIZE_MD4 = 1024*63; // 1024 * 100; // F000 = 61 440 bytes


function WeGetFileHash_Md4(fName: string; var HashResult: THashResultRec; HashEnumProc: THashEnumProc = nil): Boolean;
function WeGetStreamHash_Md4(AStream: TStream; var HashResult: THashResultRec; StartPos: Int64 = 0; HashEnumProc: THashEnumProc = nil): Boolean;
...
var
  ...
  BufNo: integer;
  Buffer: array[0..HASH_BUFFER_SIZE_MD4-1] of Byte;
...
begin
  ...
  try
    ...
    begin
      ...
      if xRead > 0 then MD4Update(Context, @Buffer, xRead);
...
begin
  ...
  try
    Result := WeGetStreamHash_Md4(fs, HashResult, 0, HashEnumProc);
  finally
    fs.Free;
  end;
end;

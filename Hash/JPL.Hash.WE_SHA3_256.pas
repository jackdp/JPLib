...
uses
  ...
  Hash, Mem_util, sha3_256
  ;

const
  HASH_BUFFER_SIZE_SHA3_256 = 1024*63; // 1024 * 100; // F000 = 61 440 bytes


function WeGetFileHash_SHA3_256(fName: string; var HashResult: THashResultRec; HashEnumProc: THashEnumProc = nil): Boolean;
function WeGetStreamHash_SHA3_256(AStream: TStream; var HashResult: THashResultRec; StartPos: Int64 = 0; HashEnumProc: THashEnumProc = nil): Boolean;
...
var
  ...
  BufNo: integer;
  Buffer: array[0..HASH_BUFFER_SIZE_SHA3_256-1] of Byte;
...
begin
  ...
  try
    ...
    HashResult.HashType := htSha3_256;
    ...
    begin
      ...
      if xRead > 0 then SHA3_256Update(Context, @Buffer, xRead);
...
begin
  ...
  try
    Result := WeGetStreamHash_SHA3_256(fs, HashResult, 0, HashEnumProc);
  finally
    fs.Free;
  end;
end;

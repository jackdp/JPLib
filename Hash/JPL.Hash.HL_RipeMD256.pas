...
uses
  ...
  HlpHash, HlpHashResult, HlpIHashResult, HlpRIPEMD256;
...
function HlGetFileHash_RipeMd256(fName: string; var HashResult: THashResultRec; HashEnumProc: THashEnumProc = nil): Boolean;
function HlGetStreamHash_RipeMd256(AStream: TStream; var HashResult: THashResultRec; StartPos: Int64 = 0; HashEnumProc: THashEnumProc = nil): Boolean;
...
begin
  ...
  Hash := TRIPEMD256.Create;
  try
    Logger.StartLog;
    ClearHashResultRec(HashResult);
    HashResult.HashType := htRipeMD256;
...
begin
  ...
  try
    Result := HlGetStreamHash_RipeMd256(fs, HashResult, 0, HashEnumProc);
  finally
    fs.Free;
  end;
end;
